...
export default class FantasyGoldinfoAPIService extends Service {
  constructor(options) {
    super(options)
  ...
  setupRoutes(app) {
    ...
    router.get(
      '/address/:address/fgc20-balance-history',
      this.addresses.checkAddresses.bind(this.addresses),
      this.addresses.fgc20BalanceHistory.bind(this.addresses)
    )
    ...
    router.get('/contract/fgc20-tokens', this.contracts.fgc20Tokens.bind(this.contracts))
    router.get(
      '/contract/:contract',
