# [fantasygold.info](htts://fantasygold.info/) API

API endpoint of [fantasygold.info](https://fantasygold.info) is https://fantasygold.info/api/


## Table of Contents
- [fantasygold.info API](#fantasygoldinfo-api)
  ...
  - [Addresses](#addresses)
    ...
    - [Address fgc20 token balance history](#address-fgc20-token-balance-history)
  - [Contracts](#contracts)
    - [FGC20 token list](#fgc20-token-list)
...
### Address fgc20 token balance history
```
GET /address/:address/fgc20-balance-history
```
```
Request Params
...
```
```
GET /address/QXDZB2c4TBRSWqYY1ifQQHMu9MuiDW3oYi/fgc20-balance-history
```
```json
{
  "totalCount": 3,
...
```
```
GET /contract/fgc20-tokens?pageSize=10
```
```json
{
  "totalCount": 207,
