<template>
  <div class="columns is-multiline transaction-item">
    ...
    <template v-for="({token, from, to, amount}, index) in fgc20TokenTransfers">
      <div class="column is-full flex-full"></div>
      <AttributeInjector
    ...
    <template v-for="({token, from, to, tokenId}, index) in fgc721TokenTransfers">
      <div class="column is-full flex-full"></div>
      <AttributeInjector
        class="column collapse token-transfer-list"
        :class="{
