...
import fgc20List from './fgc20-abi.json'
import fgc721List from './fgc721-abi.json'
...
export const fgc20ABIs = fgc20List.map(abi => {
...
export const fgc721ABIs = fgc721List.map(abi => {
  if (abi.type === 'function') {
    return new MethodABI(abi)
  } else if (abi.type === 'event') {
    return new EventABI(abi)
