...
import {Header as RawHeader, Block as RawBlock, Address, Solidity} from 'fantasygoldinfo-lib'
...
export default class BlockService extends Service {
  ...
  async __onBlock(rawBlock) {
    ...
    let contractTransactionList = await FantasyGoldBalanceChanges.distinct('id', {
