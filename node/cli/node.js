...
class FantasyGoldNode {
  ...
  async start() {
    ...
    this.#node = new Node({
      ...this.#config,
      path: path.resolve(this.#path, 'fantasygoldinfo-node.json'),
      services
    })
    this.registerExitHandlers()
    this.#node.on('ready', () => this.logger.info('FantasyGoldinfo Node ready.'))
...
module.exports = FantasyGoldNode
